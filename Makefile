...
kerr-equatorial : kerr-equatorial.o kerr-equatorial-coeffs.o kerr-equatorial-dtcoeffs.o kerr-equatorial-dttcoeffs.o mine.o decompose.o $(DEPS)
	gcc $(CFLAGS) -o kerr-equatorial kerr-equatorial-coeffs.o kerr-equatorial-dtcoeffs.o kerr-equatorial-dttcoeffs.o kerr-equatorial.o mine.o decompose.o $(LDFLAGS) $(LIBS)

kerr-circular : kerr-circular.o effsource.o decompose.o $(DEPS)
	gcc $(CFLAGS) -o kerr-circular kerr-circular.o mine.o decompose.o $(LDFLAGS) $(LIBS)

effsource.o : effsource.c
	gcc $(CFLAGS) -O3 -c -o mine.o mine.c

decompose.o : ./test/decompose.c
	gcc $(CFLAGS) -O3 -c -o decompose.o ./test/decompose.c
